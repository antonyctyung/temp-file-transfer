...
int xoodyak_crypto_aead_encrypt(
    ...
    const unsigned char *k)
{
    ...
    Xoodyak_Initialize(&instance, k, XOODYAK_CRYPTO_KEYBYTES, npub, XOODYAK_CRYPTO_NPUBBYTES, NULL, 0);
...
int xoodyak_crypto_aead_decrypt(
