...
#include "photonbeetle_128_api.h"
...
#define KEY_INBITS (PHOTONBEETLE_128_CRYPTO_KEYBYTES * 8)
#define KEY_INBYTES (PHOTONBEETLE_128_CRYPTO_KEYBYTES)

#define NOUNCE_INBITS (PHOTONBEETLE_128_CRYPTO_NPUBBYTES * 8)
#define NOUNCE_INBYTES (PHOTONBEETLE_128_CRYPTO_NPUBBYTES)
